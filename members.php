...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="admin-login.php"><img height="100px" width="100px" src="img/ic4.png" alt="Tuitions Tonight Logo"></a>
...
<form>
  ...
  <div class="form-group">
    ...
    <input type="date" name="date" class="form-control" id="inputAddress" placeholder="Date of Birth">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="tel" name="phone" class="form-control" id="inputAddress2" pattern='[1-9]{1}[0-9]{9}' placeholder="phone">
  </div>
  <div class="form-group">
